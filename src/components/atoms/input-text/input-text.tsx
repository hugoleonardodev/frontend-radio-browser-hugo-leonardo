...
const InputText: React.FC<InputTextProps> = ({
  ...
  const labelClasses = clsx(
    'absolute cursor-text w-[98%] left-[1px] text-base text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-5 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-purple-600 peer-focus:dark:text-purple-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-5 peer-focus:w-max peer-[.placeholder-green-700]:w-max peer-[.placeholder-purple-700]:w-max',
    {
